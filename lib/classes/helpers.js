...
function TweetHelperClass () {
  ...
  this.formatTweetText = function (text) {
    var regEx1 = /#([^ ]+)/gi;
    var regEx2 = /@([^ ]+)/gi;
    var pattern1 = '<a href="https://twitter.com/search?q=%23$1">#$1</a>';
    var pattern2 = '<a href="http://twitter.com/$1">@$1</a>';
    return text.replace(regEx1, pattern1).replace(regEx2, pattern2);
  }
}
